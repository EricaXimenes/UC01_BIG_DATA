...
# Obtendo os Quartis da renda - Método weibull
...
# Obtendo os Quartis do empréstimo - Método weibull
q1_emprestimo = np.quantile(array_financeira_Vlr_emprestado, 0.25, method='weibull')
...
iqr_emprestimo = q3_renda - q1_renda
...
limite_superior_Vlr_emprestado = q3_emprestimo + (1.5 * iqr_emprestimo)
limite_inferior_Vlr_emprestado = q1_emprestimo - (1.5 * iqr_emprestimo)
...
# Filtrando o DataFrame financeira
df_financeira_emprestimo_outliers_superiores = df_financeira[df_financeira['Vlr_emprestado'] > limite_superior_Vlr_emprestado]
df_financeira_emprestimo_outliers_inferiores = df_financeira[df_financeira['Vlr_emprestado'] < limite_inferior_Vlr_emprestado]
...
print(f"O valor do q1 - 25% da renda é R$ {q1_emprestimo:.2f}")
print(f"O valor do q2 - 50% da renda é R$ {q2_emprestimo:.2f}")
print(f"O valor do q3 - 75% da renda é R$ {q3_emprestimo:.2f}")
print(f"O valor do iqr = q3 - q1 da renda é R$ {iqr_emprestimo:.2f}")
print(f"O limite inferior da renda é R$ {limite_inferior_Vlr_emprestado:.2f}")
print(f"O limite superior da renda é R$ {limite_superior_Vlr_emprestado:.2f}")
print('\n- Verificando a existência de outliers inferiores -')
