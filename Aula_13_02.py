...
df_hom_doloso_roubo_veiculo = df_ocorrencias[['cisp','hom_doloso','roubo_veiculo']]
df_hom_doloso_roubo_veiculo = df_hom_doloso_roubo_veiculo.groupby(['cisp']).sum(['hom_doloso','roubo_veiculo']).reset_index()
...
correlacao_hom = np.corrcoef(df_hom_doloso_roubo_veiculo['hom_doloso'],df_hom_doloso_roubo_veiculo['roubo_veiculo'])[0,1]
...
plt.scatter(df_hom_doloso_roubo_veiculo['hom_doloso'],df_hom_doloso_roubo_veiculo['roubo_veiculo'])
plt.xlabel('Homicídio Doloso')
plt.ylabel('Roubo Veiculo')
