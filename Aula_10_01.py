...
#Obtendo as medidas de dispersão da renda 
...
print(f"O desvio padrão das rendas dos clientes é R${distancia_var_renda:.2f}")
...
print(f"A Variância do valor emprestado dos clientes é R${variancia_Vlr_emprestado:.2F}")
print(f"A distância da Variância X média do valor emprestado dos clientes é {distancia_var_Vlr_emprestado:.2f}")
print(f"O desvio padrão do Valor emprestado dos clientes é R${distancia_var_renda:.2f}")
print(f"O Coeficiente de variação do valor emprestado dos clientes é {coeficiente_var_Vlr_emprestado:.2f}")
print('\n- Verificando a existência de outliers inferiores -')
print('\n- Verificando a existência de outliers inferiores -')
