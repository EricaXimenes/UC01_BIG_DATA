...
df_fare_age = df_titanic[['Name','Age','Fare','Survived']] #filtrar dados
...
#Obtendo as medidas de dispersão do Fare
...
#Obtendo as medidas de dispersão do Age
...
print(f"A Variância das passagens dos clientes é R${variancia_fare:.2F}")
print(f"A distância da Variância X média das passagens dos clientes é {distancia_var_fare:.2f}")
print(f"O desvio padrão das passagens dos clientes é R${distancia_var_fare:.2f}")
print(f"O Coeficiente de variação das passagens dos clientes é {coeficiente_var_fare:.2f}")
...
print(f"A Variância das idades dos clientes é {variancia_Age:.2F}")
print(f"A distância da Variância X média das idades dos clientes é {distancia_var_Age:.2f}")
print(f"O desvio padrão das idades dos clientes é {distancia_var_Age:.2f}")
print(f"O Coeficiente de variação das idades dos clientes é {coeficiente_var_Age:.2f}")
print('\n- Verificando a existência de outliers inferiores -')
...
plt.suptitle('Análise dos Dados sobre Passagens X Idades')

# posição 01: Gráfico das passagens
df_titanic_fare_outliers_superiores_order = df_titanic_fare_outliers_superiores.sort_values(by='Fare',ascending=True)
plt.subplot(2,2,1)
plt.xticks([])
plt.title('Lista das Passagens')
...
plt.bar(df_titanic_age_outliers_superiores_order['Name'],df_titanic_age_outliers_superiores_order['Age'])

# posição 03: Medidas descritivas das passagens
plt.subplot(2,2,3)
plt.title('Medidas Descritivas das Passagens')
plt.axis('off')
plt.text(0.1,0.9,f'Média das Passagens {media_fare}',fontsize=12)
plt.text(0.1,0.8,f'Mediana das Passagens {mediana_fare}',fontsize=12)
plt.text(0.1,0.7,f'Distância entre Média e Mediana das Passagens {distancia_fare}',fontsize=12)
plt.text(0.1,0.6,f'Maior valor das Passagens {maximo_fare}',fontsize=12)
plt.text(0.1,0.5,f'Menor valor das Passagens {minimo_fare}',fontsize=12)
plt.text(0.1,0.4,f'Distância entre a Variância e Média das Passagens {distancia_var_fare}',fontsize=12)
plt.text(0.1,0.3,f'Coeficiente de variação das Passagens {coeficiente_var_fare}',fontsize=12)

# posição 04: Medidas descritivas das idades
plt.subplot(2,2,4)
plt.title('Medidas Descritivas das Idades')
plt.axis('off')
plt.text(0.1,0.9,f'Média das Idades {media_age}',fontsize=12)
plt.text(0.1,0.8,f'Mediana das Idades {mediana_age}',fontsize=12)
plt.text(0.1,0.7,f'Distância entre Média e Mediana das Idades {distancia_age}',fontsize=12)
plt.text(0.1,0.6,f'Maior valor das idades {maximo_age}',fontsize=12)
plt.text(0.1,0.5,f'Menor valor das idades {minimo_age}',fontsize=12)
plt.text(0.1,0.4,f'Distância entre a Variância e Média das idades {distancia_var_Age}',fontsize=12)
plt.text(0.1,0.3,f'Coeficiente de variação das idades {coeficiente_var_Age}',fontsize=12)
