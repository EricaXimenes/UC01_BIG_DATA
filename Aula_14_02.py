...
df_lesao_corp_dolosa = df_lesao_corp_dolosa[df_lesao_corp_dolosa['ano'].isin([2022,2023,2024])] #O filtro deve ser aplicado antes do agrupamento.
...
plt.barh(df_lesao_dolosa_outliers_superiores_order['cisp'].astype(str),df_lesao_dolosa_outliers_superiores['lesao_corp_dolosa'].sort_values(), color= 'red', edgecolor= 'green')
