...
print("\n--------- OBTENDO INFORMAÇÕES SOBRE OS RECUPERAÇÃO DE VEÍCULOS -----------")
print("---------------------------------------------------------------------")
print('------------------ Medidas de Tendência Central ---------------------')
print("---------------------------------------------------------------------")
print(f"A média dos recuperação de veículos é {media_rec_veiculo:.0f}")
print(f"A mediana dos recuperação de veículos é {mediana_rec_veiculo:.0f}")
print(f"A distância entre a média e a mediana é dos recuperação de veículos é {distancia_rec_veiculo:.2f} %")
print(f"O menor valor dos recuperação de veículos é {minimo_rec_veiculo:.0f}")
print(f"O maior valor dos recuperação de veículos é {maximo_rec_veiculo:.0f}")
print(f"A amplitude dos valores dos recuperação de veículos é {amplitude_rec_veiculo:.0f}")
print(f"O valor do q1 - 25% dos recuperação de veículos é {q1_rec_veiculo:.0f}")
print(f"O valor do q2 - 50% dos recuperação de veículos é {q2_rec_veiculo:.0f}")
print(f"O valor do q3 - 75% dos recuperação de veículos é {q3_rec_veiculo:.0f}")
print(f"O valor do iqr = q3 - q1 dos recuperação de veículos é {iqr_rec_veiculo:.0f}")
print(f"O limite inferior dos recuperação de veículos é {limite_inferior_rec_veiculo:.0f}")
print(f"O limite superior dos recuperação de veículos é {limite_superior_rec_veiculo:.0f}")
print(f"A variância dos recuperação de veículos é {variancia_rec_veiculo:.0f}")
print(f"A distância da variância X média dos recuperação de veículos é {distancia_var_rec_veiculo:.0f}")
print(f"O desvio padrão dos recuperação de veículos é {desvio_padrao_rec_veiculo:.0f}")
print(f"O coeficiente de variação dos recuperação de veículos é {coeficiente_var_rec_veiculo:.0f}")
...
plt.subplot(2,2,2)
plt.title('Histograma dos Recuperação de Veículos')
...
plt.axis('off')
plt.text(0.1,0.9,f'Média dos Roubos de Veículos {media_rec_veiculo:.0f}',fontsize=12)
plt.text(0.1,0.8,f'Mediana dos Roubos de Veículos {mediana_rec_veiculo:.0f}',fontsize=12)
plt.text(0.1,0.7,f'Distância entre Média e Mediana dos Roubos de Veículos {distancia_rec_veiculo:.2f}%',fontsize=12)
plt.text(0.1,0.6,f'Maior valor dos Roubos de Veículos {maximo_rec_veiculo:.0f}',fontsize=12)
plt.text(0.1,0.5,f'Menor valor dos Roubos de Veículos {minimo_rec_veiculo:.0f}',fontsize=12)
plt.text(0.1,0.4,f'Distância entre a Variância e Média dos Roubos de Veículos {distancia_var_rec_veiculo:.2f}',fontsize=12)
plt.text(0.1,0.3,f'Coeficiente de variação dos Roubos de Veículos {coeficiente_var_rec_veiculo:.2f}',fontsize=12)
